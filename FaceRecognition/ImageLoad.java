...
public class ImageLoad  {
 ...
 public double work() throws IOException  {
     ...
     // webcame objcet
     WebcameCapture web= new WebcameCapture();
     ...
     {
          //cropping of image
       CropppingOfImage crop=new CropppingOfImage();
       //histogram equilization
       HistogramEqui hist=new HistogramEqui("E:\\Face recognition test\\image1.jpg");
     ...
     ImageToPixel pixel=new ImageToPixel();
        ...
        if (dir.isDirectory()) { // make sure it's a directory
            ...
            for (final File f : dir.listFiles(IMAGE_FILTER)) {
                ...
                try {
                   ...
                   ImageIO.write(img, "jpg", new File("E:\\Face recognition test\\image.jpg"));
                   //cropping the image
                   CropppingOfImage crop2 =new CropppingOfImage(); 
                   //normalizing the image with histogram quilization
                   HistogramEqui hist2 =new HistogramEqui("E:\\Face recognition test\\image1.jpg");
                   //creating  obk=ject of the Image_to_pixel class
                   ImageToPixel pixel2 = new ImageToPixel();
                   ...
                   int [][] mat2= pixel.Image_to_pixel_method();
                    ...
                    FaceSimillarityPercentage percentage =new FaceSimillarityPercentage();
